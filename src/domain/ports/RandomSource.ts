 ...
 *
 * Le domaine n'utilise JAMAIS `Math.random()` directement, sinon
 * les tests deviennent non déterministes. En tests on injecte
 * une source à graine fixe (`SeededRandomSource`).
 */
